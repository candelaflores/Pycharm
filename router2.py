...
configurar = [
    '/ip address add address=172.26.17.1/25 interface=ether3',
    '/ip address add address=192.168.17.1/30 interface=ether2',
    '/ip pool add name=pool_lan_2 ranges=172.26.17.1-172.26.17.126',
    '/ip dhcp-server add address-pool=pool_lan_2 interface=ether3 name=dhcp_lan_2',
    '/ip dhcp-server network add address=172.26.17.0/25 gateway=172.27.17.1',
